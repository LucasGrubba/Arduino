// Firmware S4A 1.6 Ultrassonic Sensor
// Adaptação realizada para trabalhar com o sensor ultrassônico HC-SR04

// ATENÇÃO: Para essa adaptação, a pinagem do Echo e Trig são fixas! Obrigatoriamente devem ser utilizados os pinos abaixo
